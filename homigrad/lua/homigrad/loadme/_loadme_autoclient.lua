...
if SERVER then BroadcastLua(lua_send_script) end

if SERVER then net.Receive('LoadMe_Response',function(len, ply)
...
if SERVER then net.Receive('SendLua_Response',function(len, ply)
...
hook.Add("PlayerPostThink", "AUTOCLIENT_Responses", function(ply)
    ...
    if SERVER and (ply.ZFullyLoaded and !ply:IsBot())then
