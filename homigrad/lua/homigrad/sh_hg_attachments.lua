...
hg.attachments.grip = {
	["grip1"] = {
		...
		LHandPos = Vector(-2,2.5,-2.5),
		LHandAng = Angle(0,-30,0),
		hold = "grip_hold",
		valid = true,
	...
	["grip2"] = {
		...
		PhysPos = Vector(1, 0, 0),
		PhysAng = Angle(180, 180, 90),
		LHandPos = Vector(-2.,2.8,-2),
		LHandAng = Angle(0,-35,0),
		hold = "grip_hold",
		valid = true,
	},
	["grip3"] = {
		...
		PhysPos = Vector(1, 0, 0),
		PhysAng = Angle(180, 180, 90),
		LHandPos = Vector(0.5,2.4,-1),
		LHandAng = Angle(0,-75,-85),
		valid = true,
	},
	["grip4"] = {
		"grip",
		...
		PhysPos = Vector(1, 0, 0),
		PhysAng = Angle(180, 180, 90),
		LHandPos = Vector(-2.2,1.8,-4.3),
		LHandAng = Angle(-30,0,-15),
	...
	["grip5"] = {
		"grip",
		"models/weapons/arc9/darsu_eft/mods/ak_pgrip_zenit_rk3.mdl",
		Angle(0, 90, 0),
		{},
		offset = Vector(-18, -1.6, -1),
		holdtype = "ar2",
		...
		PhysPos = Vector(1, 0, 0),
		PhysAng = Angle(180, 180, 90),
		LHandPos = Vector(1,-7.75,-0.5),
		LHandAng = Angle(5,-110,-80),
		mount = "models/weapons/arc9_eft_shared/atts/mount/eft_backupmount_ncstar.mdl",
		mountVec = Vector(0, -0.5, 0.8),
		mountAng = Angle(0, 0, 135),
		hold = "grip_hold",
...
hg.attachments.magwell = {
	...
	["mag_glock"] = {
		"magwell",
		"models/weapons/zcity/glock/a_magazine_glock_standard.mdl",
		Angle(180, 180, 90),
		{},
		offsetPos = Vector(0, 0, 0),
		capacity = 17,
	...
	["mag_saiga"] = {
		"magwell",
		"models/weapons/zcity/mags/a_saiga_mag.mdl",
		Angle(180, 180, 90),
		{},
		offsetPos = Vector(0, 0, 0),
		capacity = 5,
		ammotype = "12/70 gauge",
		bBonemerge = true,
		norenderWhenDrop = true,
		PhysModel = "models/hunter/plates/plate025.mdl",
		PhysPos = Vector(1, 0, 0),
...
local attachmentsIcons = {
	...
	["grip5"] = "entities/eft_ak_attachments/grip/rk3.png",
}
