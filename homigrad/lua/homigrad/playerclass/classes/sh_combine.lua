...
local callsigns = {
    ...
    "Foxtrot","Tango","Sierra","Uniform","Kilo","Yankee"
}
...
if CLIENT then
    local color_hp = Color(15,165,165,220)
    local color_ar = Color(15,165,165,220)
    ...
    function CLASS.HUDPaint(self)
        ...
        do
            ...
            local _,txt_size_y = surface.GetTextSize(self:Health())
            hp_txt = math.min(hp_txt + 1, self:Health())
            ...
            draw.DrawText("STIMDOSE","CMBFontSmall",
        ...
        do
            ...
            draw.DrawText("HEARTBEAT PER MINUTE","CMBFontSmall",
        ...
        do
            ...
            draw.DrawText("ENDURANCE","CMBFontSmall",
...
if SERVER then
    hook.Add("HG_PlayerFootstep","Combine_footsteps",function(ply)
        ...
        if ply:Alive() and ply.PlayerClassName == "Combine" then
            ...
            chr:EmitSound("npc/combine_soldier/gear" .. math.random(1,6) .. ".wav",
                (ply:KeyDown(IN_DUCK) or ply:KeyDown(IN_WALK)) and 65 or 75
            )
        end
    end)
    ...
    hook.Add("PlayerSay","CombineChatMessage",function(ply,text)
