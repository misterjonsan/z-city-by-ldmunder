...
bloodparticles2 = bloodparticles2 or {}
...
local function addBloodPart(pos, vel, mat, w, h, artery, kishki, owner)
	...
	if #bloodparticles1 > 200 then table.remove(bloodparticles1, 1) end
	
	bloodparticles1[#bloodparticles1 + 1] = {pos, pos2, vel, mat or mat_huy, w or 2, h or 2, CurTime(), artery = artery, kishki = kishki, owner = owner, start_velocity = IsValid(owner) and owner:GetVelocity() or vector_origin}
end
...
local function addBloodPart2(pos, vel, mat, w, h, time, water, owner)
	...
	if #bloodparticles2 > 200 then table.remove(bloodparticles2, 1) end
	--if water and math.random(2) == 1 then return end
	--if water and math.random(3) > 1 then return end

	bloodparticles2[#bloodparticles2 + 1] = {pos, pos2, vel, mat or cloudmat, w or 60, h or 60, CurTime() + time, time, water = water, owner = owner}
end
