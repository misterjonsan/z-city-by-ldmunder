...
module[2] = function(owner, org, timeValue)
    ...
    local calculatedMax = (org.superfighter and 2 or 1) * ((stamina.range * (1 - (org.pneumothorax) / 2) + org.adrenaline * 20 ) * math.max(1 - org.hemotransfusionshock,0.2)) * math.max(1 - (org.hungry/100),0.65)
    stamina.max = org.stamina.adminMax or calculatedMax
