...
local Selects = {
    ...
    {Title = "Telegram (Ultragrad)", Func = function(luaMenu) luaMenu:Close() gui.OpenURL("https://t.me/ultrarehab")  end},
    {Title = "Discord (Z-city)", Func = function(luaMenu) luaMenu:Close() gui.OpenURL("https://discord.gg/475EmEdTgH")  end},
    {Title = "Binds and Mechanics", Func = function(luaMenu) gui.OpenURL("https://zcity-help.ru/wiki/") end},
   -- {Title = "Wikipedia", Func = function(luaMenu) luaMenu:Close() gui.OpenURL("http://zcity-help.ru/zcity_wiki") end},
    ...
    --{Title = "thanks", Func = function(luaMenu) luaMenu:Close() RunConsoleCommand("hg_thanks") end}, -- я эту хуйню из-за разрешения как будто не доделаю никогда
