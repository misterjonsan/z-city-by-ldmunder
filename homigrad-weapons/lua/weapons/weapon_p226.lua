...
SWEP.Instructions = [[The SIG Sauer P226 pistol was developed in 1981 to participate in the American XM9 competition for a new pistol for the U.S. Army. It was essentially a SIG Sauer P220 pistol that was in service with the Swiss Armed Forces. This weapon chambered on 9x19 mm parabellum]]
SWEP.Category = "Weapons - Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/zcity/w_pist_px4.mdl"
SWEP.WorldModelFake = "models/weapons/arc9/darsu_eft/c_p226.mdl" --https://steamcommunity.com/sharedfiles/filedetails/?id=3544105055
//PrintBones(Entity(1):GetActiveWeapon():GetWM())
--uncomment for funny
SWEP.FakePos = Vector(-15.5, 5.1, 6.6)
SWEP.FakeAng = Angle(0, 0, 0)
SWEP.AttachmentPos = Vector(0,0,0)
SWEP.AttachmentAng = Angle(0,0,0)
SWEP.FakeAttachment = "1"
SWEP.FakeBodyGroups = "12115112"
SWEP.FakeEjectBrassATT = "2"
//SWEP.MagIndex = 6
//MagazineSwap
--Entity(1):GetActiveWeapon():GetWM():AddLayeredSequence(Entity(1):GetActiveWeapon():GetWM():LookupSequence("delta_foregrip"),1)
SWEP.FakeReloadSounds = {
	[0.2] = "weapons/darsu_eft/mp443/grach_mag_out.ogg",
	[0.3] = "weapons/darsu_eft/mp443/grach_mag_pullin.ogg",
	[0.8] = "weapons/darsu_eft/mp443/grach_mag_in.ogg",
}
...
SWEP.FakeEmptyReloadSounds = {
	...
	[0.87] = "weapons/darsu_eft/mp443/grach_mag_in.ogg",
	[1.07] = "weapons/darsu_eft/mp443/grach_catch_slider.ogg",
}
...
SWEP.WepSelectIcon2 = Material("arccw/weaponicons/arccw_ur_m1911")
SWEP.IconOverride = "entities/ucepicfail.png"
...
SWEP.Primary.Sound = {"weapons/darsu_eft/p226/pm_indoor_close2.wav", 75, 90, 100}
...
SWEP.ZoomPos = Vector(-3, 0.82, 4.4989)
...
SWEP.lengthSub = 5
SWEP.DistSound = "weapons/darsu_eft/p226/pm_indoor_close2.wav"
