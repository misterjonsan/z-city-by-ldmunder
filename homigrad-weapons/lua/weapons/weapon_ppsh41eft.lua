...
SWEP.PrintName = "PPSH-41 EFT"
SWEP.Author = "Shpagin (LDmunder)"
SWEP.Instructions = "The 7.62 mm submachine gun model 1941 Shpagin system (PPSh) is a Soviet submachine gun developed in 1940 by the designer G. S. Shpagin under the 7.62×25 mm TT cartridge and adopted by the Red Army on December 21, 1940. PPSh along with PPS-43 was the main submachine gun of the RKKA in the Great Patriotic War."
SWEP.Category = "Weapons - Machine-Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/zcity/w_asval.mdl"
SWEP.WorldModelFake = "models/weapons/arc9/darsu_eft/c_ppsh41.mdl" -- Контент инсурги https://steamcommunity.com/sharedfiles/filedetails/?id=3437590840 
--uncomment for funny
--а еще надо настраивать заново zoompos
SWEP.FakePos = Vector(-10.5, 2.8, 8)
SWEP.FakeAng = Angle(0, 0, 0)
SWEP.AttachmentPos = Vector(35,-2,4)
...
SWEP.MagModel = "models/weapons/arc9/darsu_eft/mods/mag_ppsh_71.mdl"
...
SWEP.WepSelectIcon2 = Material("entities/arc9_eft_ppsh41.png")
SWEP.IconOverride = "entities/arc9_eft_ppsh41.png"
...
SWEP.Primary.Sound = {"weapons/darsu_eft/ppsh41/fire/ppsh_indoor_distant_loop1.wav", 65, 90, 100}
SWEP.SupressedSound = {"weapons/darsu_eft/ppsh41/fire/ppsh_indoor_distant_loop1.wav", 65, 90, 100}
...
SWEP.LocalMuzzlePos = Vector(28,-2,1)
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(0, -1.48, 6.9)
