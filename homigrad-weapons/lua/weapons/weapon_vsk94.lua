...
SWEP.Author = "Instrument Engineering Design Bureau of Russia"
SWEP.Instructions = "The VSK-94 was developed as a cheaper and more affordable alternative to the VSS Vintorez rifle, which was developed by TsNIITochMash. In fact, the VSK-94 is indeed a cheaper version of the Vintorez, as both systems use 9×39 cartridges and have similar performance characteristics. However, the VSK-94 is more technologically advanced, easier to use, cheaper to produce, and has several other advantages."
...
SWEP.MagModel = "models/weapons/arc9/darsu_eft/mods/mag_vsk94.mdl"
...
SWEP.SupressedSound = {"weapons/darsu_eft/vsk/fire_new/9a91_outdoor_close_loop1.wav", 65, 90, 100}
