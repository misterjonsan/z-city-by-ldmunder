...
SWEP.PrintName = "MK.78"
SWEP.Author = "FN Herstal"
SWEP.Instructions = "Machine gun chambered in 5.56x45 mm\n\nRate of fire 775 rounds per minute. Ванечка забыл подправить звуки так что это сорян :(."
SWEP.Category = "Weapons - Machineguns"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/w_mach_ins2_m249.mdl"
SWEP.WorldModelFake = "models/weapons/arc9/bo7/c_mk78.mdl"
SWEP.FakeAttachment = "1"
SWEP.FakeScale = 1
SWEP.FakePos = Vector(-13, 4.3, 9.45)
SWEP.FakeAng = Angle(0, -1, 0)
...
SWEP.WepSelectIcon2 = Material("entities/arc9_bo7_mk78.png")
SWEP.IconOverride = "entities/arc9_bo7_mk78.png"
...
SWEP.LocalMuzzlePos = Vector(23.632,-3,5.860)
...
SWEP.Primary.Sound = {"weapons/arc9/bo7/mk78/fire.wav", 75, 90, 100}
...
SWEP.ReloadSoundes = {
	...
	"none",
	"none",
	"weapons/arc9/bo7/mk78/magout.wav",
	"none",
	"weapons/arc9/bo7/mk78/magin.wav",
	"none",
	"none",
	"none",
	"none",
...
SWEP.lengthSub = 15
SWEP.DistSound = "weapons/arc9/bo7/mk78/fire.wav"
