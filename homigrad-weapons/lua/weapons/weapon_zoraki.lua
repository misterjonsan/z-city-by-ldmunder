...
SWEP.Author = "Zoraki"
SWEP.Instructions = "Gas pistol chambered in 9mm P.A.K"
SWEP.Category = "Weapons - Pistols"
SWEP.ViewModel = ""
SWEP.WorldModel = "models/zcity/weapons/zoraki/zoraki.mdl"

SWEP.WepSelectIcon2 = Material("vgui/icons/ico_zoraki.png")
SWEP.IconOverride = "vgui/icons/ico_zoraki.png"
...
if CLIENT then
	hook.Add("PostEntityFireBullets","zoraki906",function(self,bullet)
		...
		if LocalPlayer().organism and LocalPlayer().organism.otrub then return end
		...
		if dot < -0.5 and pos.x > 0 and pos.x < ScrW() and pos.y > 0 and pos.y < ScrH() and hg.isVisible(LocalPlayer():EyePos(), tr.StartPos, {LocalPlayer(), self}, MASK_VISIBLE) then
