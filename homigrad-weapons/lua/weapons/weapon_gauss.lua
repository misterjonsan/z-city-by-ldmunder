...
SWEP.WorldModelFake = "models/weapons/csgo/c_rif_m4a1_s.mdl" -- Контент инсурги https://steamcommunity.com/sharedfiles/filedetails/?id=3437590840 
--uncomment for funny
--а еще надо настраивать заново zoompos
SWEP.FakePos = Vector(-15, 3, 6.2)
SWEP.FakeAng = Angle(0, 0, 0)
SWEP.AttachmentPos = Vector(40,-2.8,2.2)
