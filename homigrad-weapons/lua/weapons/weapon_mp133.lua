...
SWEP.WorldModelFake = "models/weapons/arc9/darsu_eft/c_mr133.mdl" -- ОЧЕНЬ странная проблема с модельками глеба, работать начинают только если ты включишь камеру на игрока, возможно проблема в рендероверайде...
//SWEP.FakeScale = 1.5
...
SWEP.Primary.Sound = {"weapons/darsu_eft/mr133/mr133_fire_close2.ogg", 80, 90, 100}
SWEP.SupressedSound = {"weapons/darsu_eft/mr133/mr133_fire_close1.ogg", 65, 90, 100}
...
SWEP.AnimsSounds = {
	["sgreload_insert"] = {
		[0.0] = function(self)
			self:EmitSound("weapons/spas12/handling/toz_shell_insert_2.wav"..math.random(1,3)..".ogg")
			--
	...
	["cycle"] = {
		[0.0] = function(self)
			self:EmitSound("weapons/darsu_eft/mr133/mr133_pump_in.ogg")
			--
			--self:GetWM():ManipulateBoneScale(47, vector_full)
		end,
		[0.1] = function(self)
		...
		[0.2] = function(self)
			self:EmitSound("weapons/darsu_eft/mr133/mr133_pump_out.ogg")
			--
			--self:GetWM():ManipulateBoneScale(47, vector_full)
		end
	},
