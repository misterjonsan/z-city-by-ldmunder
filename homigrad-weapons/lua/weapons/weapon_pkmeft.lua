...
SWEP.Primary.Sound = {"weapons/darsu_eft/pkm/pkm_indoor_distant_loop1.wav", 75, 100, 110}
SWEP.Primary.SoundEmpty = {"zcitysnd/sound/weapons/ak47/handling/ak47_empty.wav", 75, 100, 105, CHAN_WEAPON, 2}
SWEP.Primary.Wait = 0.13
SWEP.ReloadTime = 10
SWEP.ReloadSoundes = {
	"none",
	"none",
...
SWEP.WorldModelFake = "models/weapons/arc9/darsu_eft/c_pk.mdl" -- увеличить модельку где-то в 1.5
//SWEP.FakeScale = 1.5
...
SWEP.lengthSub = 15
SWEP.DistSound = "weapons/darsu_eft/pkm/pkm_indoor_distant_loop1.wav"
