...
SWEP.PrintName = "SVD-C Escape From Tarkov"
...
SWEP.WorldModelFake = "models/weapons/arc9/darsu_eft/c_svds.mdl" -- Контент инсурги https://steamcommunity.com/sharedfiles/filedetails/?id=3437590840 
--uncomment for funny
--а еще надо настраивать заново zoompos
SWEP.FakePos = Vector(-15, 2.3, 5.25)
SWEP.FakeAng = Angle(0, 0, 0)
SWEP.AttachmentPos = Vector(45,-3,4)
...
SWEP.GetDebug = false
SWEP.MagModel = "models/weapons/arc9/darsu_eft/mods/mag_svd_10_dropped.mdl"
...
SWEP.WepSelectIcon2 = Material("entities/svds.png")
SWEP.WepSelectIcon2box = true
SWEP.IconOverride = "entities/svds.png"
SWEP.weight = 4
SWEP.weaponInvCategory = 1
SWEP.CustomShell = "762x54"
SWEP.EjectPos = Vector(5.1,20,-2)
...
SWEP.FakeBodyGroups = "0100101111"
SWEP.Primary.Ammo = "7.62x54 mm"
SWEP.Primary.Cone = 0
SWEP.Primary.Spread = 0
SWEP.Primary.Damage = 69
SWEP.Primary.Force = 65
SWEP.Primary.Sound = {"weapons/darsu_eft/svds/svd_fire_close.ogg", 65, 90, 100}
SWEP.SupressedSound = {"weapons/darsu_eft/svds/svd_fire_distant_silenced.ogg", 65, 90, 100}
...
SWEP.LocalMuzzlePos = Vector(35,-2,-3)
...
SWEP.DistSound = "weapons/darsu_eft/svds/svd_fire_distant.ogg"
