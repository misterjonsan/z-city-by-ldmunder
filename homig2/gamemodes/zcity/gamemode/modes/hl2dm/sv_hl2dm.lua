...
function MODE:GiveEquipment()
	timer.Simple(0.1, function()
		...
		for _, ply in RandomPairs(players_alive) do
			...
			ply:SetPlayerClass(ply:Team() == 1 and "Combine" or "Rebel", {bNoEquipment = false})
...
util.AddNetworkString("RequestAirstrike")
...
net.Receive("RequestAirstrike", function(len, ply)
