...
SWEP.WorldModel = "models/wierd/dildo.mdl"
SWEP.WorldModelReal = "models/weapons/tfa_nmrih/v_me_hatchet.mdl"
SWEP.WorldModelExchange = "models/wierd/dildo.mdl"
SWEP.ViewModel = ""
...
SWEP.weaponPos = Vector(1,0,-9)
SWEP.weaponAng = Angle(0,260,0)
...
if CLIENT then
	SWEP.WepSelectIcon = Material("addons/homigrad-materials/dildo2.png")
	SWEP.IconOverride = "addons/homigrad-materials/dildo.png"
